...
_L5:
	...
	_t34 := _t36 int - 32
	_t35 := _t34 int * 4
	_t33 := torquemada[_t35]
	_t32 := _t33
	_t31 := _t32
	_t40 := 432
	_t39 := _t40
	_t30 := _t31 <> _t39
	_t2 := _t3 int and _t30
	_t46 := a
	_t50 := inttoreal _t52
	_t45 := _t46 real + _t52
	_t65 := 32
...
Feb 12 11:32 2014 samples/typecheck1.pas.tac Page 1
...
__bob:					    _t3 := _t4
	...
	_t2 := _t3			    _t5 := a real * 23
	_t1 := _t2			    _t4 := _t5
	_t18 := c			    _t3 := _t4
	_t17 := _t18			    c := _t3
	_t0 := _t1 <> _t17		    goto _L6
	if _t0 goto _L3		    _L8:
	goto _L4		    _L5:
_L3:					    _t11 := 3
	_t24 := 234			    _t10 := _t11
	_t23 := _t24			    _t9 := _t10
	_t22 := _t23			    _t7 := _t9 int - 2332
	push _t22			    _t8 := _t7 int * 8
	_t27 := 32			    _t6 := d[_t8]
	_t26 := _t27			    _t5 := _t6
	_t25 := _t26			    _t4 := _t5
	push _t25			    _t19 := 11
	_t30 := 23			    _t22 := 32
	_t29 := _t30			    _t18 := _t19 int + _t22
	_t28 := _t29			    _t25 := 3
	push _t28			    _t18 := _t18 int + _t25
	_t33 := 23			    _t17 := _t18
	_t32 := _t33			    _t15 := _t17 int - 333
	_t31 := _t32			    _t16 := _t15 int * 8
	push _t31			    _t14 := putin[_t16]
	_t36 := 23			    _t13 := _t14
	_t35 := _t36			    _t12 := _t13
	_t34 := _t35			    _t3 := _t4 = _t12
	push _t34			    _t38 := 323
	call __bob_lolwut		    _t37 := _t38
	goto _L5			    _t36 := _t37
_L4:					    _t34 := _t36 int - 32
_L6:					    _t35 := _t34 int * 4
	_t2 := a			    _t33 := torquemada[_t35]
	_t1 := _t2			    _t32 := _t33
	_t7 := c			    _t31 := _t32
	_t6 := _t7			    _t40 := 432
	_t0 := _t1 < _t6		    _t39 := _t40
	if _t0 goto _L7			    _t30 := _t31 <> _t39
	goto _L8			    _t2 := _t3 int and _t30
_L7:					    _t46 := a
	_t5 := a int * 32		    _t50 := inttoreal _t52
	_t15 := inttoreal _t5		    _t45 := _t46 real + _t52
...
Feb 12 11:32 2014 samples/typecheck1.pas.tac Page 2
...
Feb 12 11:32 2014 samples/typecheck1.pas.tac Page 3
	...
	goto _L14			    _t5 := 1.100000
_L13:					    _t4 := _t5
	_t2 := 2332			    _t3 := _t4
	_t5 := 32			    push _t3
	_t1 := _t2 int + _t5		    _t8 := 3.300000
	_t8 := 32			    _t7 := _t8
	_t1 := _t1 int + _t8		    _t6 := _t7
	_t11 := a			    push _t6
	_t1 := _t1 int + _t11		    _t11 := kimjongun
	_t17 := c			    _t10 := _t11
	_t15 := inttoreal _t17		    _t9 := _t10
	_t1 := _t1 real + _t17		    push _t9
	_t1 := _t1 real + _t11		    _t17 := bosstweed
	_t1 := _t1 real + _t8		    _t16 := _t17
	_t1 := _t2 real + _t5		    _t15 := _t16
	_t0 := _t1			    push _t15
	push _t0			    call __bob_lolwut
	_t23 := 32 int * a	    _L11:
	_t33 := inttoreal _t23		    return
	_t23 := _t33 real * c
	_t47 := 32		    __bob_lolwut:
	_t50 := 32			    _beginfunc
	_t46 := _t47 int + _t50		    _t2 := a
	_t45 := _t46			    _t1 := _t2
	_t43 := _t45 int - 333		    _t7 := b
	_t44 := _t43 int * 8		    _t6 := _t7
	_t42 := putin[_t44]		    _t0 := _t1 <> _t6
	_t23 := _t23 real * _t42	    if _t0 goto _L0
	_t23 := 32 real * a		    goto _L1
	_t22 := _t23		    _L0:
	_t21 := _t22			    _t13 := a
	push _t21			    _t12 := _t13
	call __bob_lolwut		    _t11 := _t12
	_t5 := 3232			    push _t11
	_t4 := _t5			    _t19 := b
	_t3 := _t4			    _t18 := _t19
	...
	_t8 := 2332			    _t25 := c
	_t11 := a			    _t24 := _t25
	_t7 := _t8 int + _t11		    _t23 := _t24
	_t6 := _t7			    push _t23
	putin[_t2] := _t6		    call __bob_lolwut
	goto _L12			    goto _L2
_L14:				    _L1:
	_t2 := a		    _L2:
	_t8 := 888.888000		    _t2 := a
...
Feb 12 11:32 2014 samples/typecheck1.pas.tac Page 4
	...
	return			    _L7:
					    _t5 := a int * 32
					    _t15 := inttoreal _t5
Feb 12 11:32 2014 samples/typecheck	    _t5 := _t15 real * c
					    _t5 := a real * 32
					    _t4 := _t5
__bob:
	_begin_program
...
Feb 12 11:32 2014 samples/typecheck1.pas.tac Page 5


					    goto _L11
Feb 12 11:32 2014 samples/typecheck _L10:
					    _t5 := 88 int * 88
					    _t5 := _t5 int * a
	_t73 := 32			    _t4 := _t5
	_t72 := _t73			    _t3 := _t4
