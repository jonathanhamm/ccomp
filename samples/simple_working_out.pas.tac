...
__bob:					    e := _t3
	_begin_program			    _t5 := 31
	_t5 := c			    _t4 := _t5
	_t4 := _t5			    _t3 := _t4
	_t3 := _t4			    _t1 := _t3 int -1
	c := _t3			    _t2 := _t1 int * 4
	_t5 := f			    _t14 := e
	_t4 := _t5			    _t13 := _t14
	_t3 := _t4			    _t19 := 2
...
_L1:					    _t5 := _t6
	...
	_t3 := _t4			    _t26 := 3 mod 4
	a := _t3			    _t25 := _t26
	_t2 := a			    _t24 := _t25
	_t1 := _t2			    _t22 := _t24 int - 1
	_t7 := e			    _t23 := _t22 int * 4
	_t6 := _t7			    _t21 := c[_t23]
	_t0 := _t1 = _t6		    _t20 := _t21
	if _t0 goto _L3			    _t19 := _t20
	goto _L4			    _t18 := _t19
_L3:					    _t16 := _t18 int - 1
	_t11 := 32			    _t17 := _t16 int * 4
	_t10 := _t11			    _t15 := d[_t17]
	_t9 := _t10			    _t14 := _t15
	_t7 := _t9 int - 1		    _t13 := _t14
	_t8 := _t7 int * 4		    _t12 := _t13
	_t6 := c[_t8]			    _t10 := _t12 int - 1
	_t5 := _t6			    _t11 := _t10 int * 4
	_t4 := _t5			    _t9 := c[_t11]
	_t3 := _t4			    _t8 := _t9
